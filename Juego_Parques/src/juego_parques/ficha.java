...
public class ficha {
    ...
    public boolean estaEnBase(){return enBase;}
    public boolean estaEnPasillo(){return enPasillo;}
    public boolean haLlegadoAMeta(){return haLlegadoAlaMeta;}
    public int getIndiceDeRuta(){return indiceRuta;}
    public int getIndicePasillo(){return indicePasillo;}
